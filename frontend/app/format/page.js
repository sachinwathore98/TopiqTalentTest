...
// OFFICIAL 5 ACADEMIC TIERS WITH EXACT SYLLABUS SUBJECTS
const CLASS_OPTIONS = [
  { 
    id: 'CLASS_3_5', 
  ...
  { 
    ...
    group: 'Group B',
    subjects: ['Mathematics & Science', 'English, Marathi & Mental Ability', 'Logical Reasoning & Current Affairs']
  },
  { 
    id: 'CLASS_9_10', 
    name: 'Classes 9 & 10 (Competitive Foundation)', 
    group: 'Group C',
    subjects: ['Mathematics & Science', 'Social Science & English', 'Logical Reasoning & Current Affairs']
  },
  { 
    id: 'CLASS_11_12', 
...
// TAILORED MULTILINGUAL QUESTION BANKS MATCHING EXACT SUBJECT LISTS PER GROUP
const QUESTION_BANKS = {
  CLASS_3_5: [
    { id: 1, question: { en: "Mathematics: What is 15 multiplied by 8?", hi: "गणित: 15 को 8 से गुणा करने पर क्या मिलता है?", mr: "गणित: 15 ला 8 ने गुणले असता उत्तर काय येते?" }, options: { en: ["100", "120", "130", "140"], hi: ["100", "120", "130", "140"], mr: ["100", "120", "130", "140"] }, correct: 1, explanation: { en: "15 x 8 = 120.", hi: "15 x 8 = 120.", mr: "15 x 8 = 120." } },
    { id: 2, question: { en: "Science: Which gas do plants absorb during photosynthesis?", hi: "विज्ञान: प्रकाश संश्लेषण के दौरान पौधे कौन सी गैस अवशोषित करते हैं?", mr: "विज्ञान: प्रकाशसंश्लेषणादरम्यान वनस्पती कोणती वायू शोषून घेतात?" }, options: { en: ["Oxygen", "Nitrogen", "Carbon Dioxide", "Hydrogen"], hi: ["ऑक्सीजन", "नाइट्रोजन", "कार्बन डाइऑक्साइड", "हाइड्रोजन"], mr: ["ऑक्सिजन", "नायट्रोजन", "कार्बन डायऑक्साइड", "हायड्रोजन"] }, correct: 2, explanation: { en: "Plants absorb Carbon Dioxide to produce food.", hi: "पौधे भोजन बनाने के लिए कार्बन डाइऑक्साइड अवशोषित करते हैं.", mr: "वनस्पती अन्न तयार करण्यासाठी कार्बन डायऑक्साइड शोषून घेतात." } },
    ...
    { id: 4, question: { en: "Marathi: 'सूर्य' या शब्दाचा समानार्थी शब्द कोणता?", hi: "मराठी: 'सूर्य' का पर्यायवाची शब्द क्या है?", mr: "मराठी: 'सूर्य' या शब्दाचा समानार्थी शब्द कोणता?" }, options: { en: ["चंद्र", "रवि", "मेघ", "पाणी"], hi: ["चंद्र", "रवि", "मेघ", "पानी"], mr: ["चंद्र", "रवि", "मेघ", "पाणी"] }, correct: 1, explanation: { en: "'रवि' is a synonym for Sun.", hi: "'रवि' सूर्य का पर्यायवाची है.", mr: "'रवि' हा सूर्याचा समानार्थी शब्द आहे." } },
    { id: 5, question: { en: "Logical Reasoning: Find the missing number in pattern: 2, 4, 8, 16, __", hi: "तर्कशक्ति: पैटर्न में अगली संख्या क्या होगी: 2, 4, 8, 16, __", mr: "तर्कशास्त्र: पॅटर्नमधील पुढील संख्या शोधा: 2, 4, 8, 16, __" }, options: { en: ["20", "24", "32", "64"], hi: ["20", "24", "32", "64"], mr: ["20", "24", "32", "64"] }, correct: 2, explanation: { en: "Each number is doubled: 16 x 2 = 32.", hi: "प्रत्येक संख्या दोगुनी होती है: 16 x 2 = 32.", mr: "प्रत्येक संख्या दुप्पट होते: 16 x 2 = 32." } },
    { id: 6, question: { en: "Mental Ability: How many hours are there in 2 days?", hi: "मानसिक क्षमता: 2 दिनों में कुल कितने घंटे होते हैं?", mr: "मानसिक क्षमता: 2 दिवसांत एकूण किती तास असतात?" }, options: { en: ["24", "36", "48", "60"], hi: ["24", "36", "48", "60"], mr: ["24", "36", "48", "60"] }, correct: 2, explanation: { en: "24 hours x 2 = 48 hours.", hi: "24 घंटे x 2 = 48 घंटे.", mr: "24 तास x 2 = 48 तास." } },
    { id: 7, question: { en: "General Knowledge: Which is the national bird of India?", hi: "सामान्य ज्ञान: भारत का राष्ट्रीय पक्षी कौन सा है?", mr: "सामान्य ज्ञान: भारताचा राष्ट्रीय पक्षी कोणता आहे?" }, options: { en: ["Sparrow", "Peacock", "Parrot", "Pigeon"], hi: ["गौरैया", "मोर", "तोता", "कबूतर"], mr: ["चिमणी", "मोर", "पोपट", "कबुतर"] }, correct: 1, explanation: { en: "Peacock is the national bird of India.", hi: "मोर भारत का राष्ट्रीय पक्षी है.", mr: "मोर हा भारताचा राष्ट्रीय पक्षी आहे." } },
    { id: 8, question: { en: "Mathematics: What is 50 divided by 5?", hi: "गणित: 50 को 5 से भाग देने पर क्या मिलता है?", mr: "गणित: 50 ला 5 ने भागल्यास उत्तर काय येते?" }, options: { en: ["5", "10", "15", "20"], hi: ["5", "10", "15", "20"], mr: ["5", "10", "15", "20"] }, correct: 1, explanation: { en: "50 / 5 = 10.", hi: "50 / 5 = 10.", mr: "50 / 5 = 10." } },
    { id: 9, question: { en: "Science: Which organ pumps blood in human body?", hi: "विज्ञान: मानव शरीर में कौन सा अंग रक्त पंप करता है?", mr: "विज्ञान: मानवी शरीरात कोणता अवयव रक्ताभिसरण पंप करतो?" }, options: { en: ["Lungs", "Heart", "Brain", "Kidney"], hi: ["फेफड़े", "हृदय", "मस्तिष्क", "गुर्दा"], mr: ["फुफ्फुस", "हृदय", "मेंदू", "मूत्रपिंड"] }, correct: 1, explanation: { en: "The heart pumps blood.", hi: "हृदय रक्त पंप करता है.", mr: "हृदय रक्त पंप करते." } },
    { id: 10, question: { en: "English: Choose the correct opposite of 'HOT':", hi: "अंग्रेजी: 'HOT' का सही विलोम चुनें:", mr: "इंग्रजी: 'HOT' चा विरुद्धार्थी शब्द निवडा:" }, options: { en: ["Cold", "Warm", "Bright", "Fast"], hi: ["ठंडा (Cold)", "गर्म", "चमकीला", "तेज़"], mr: ["थंड (Cold)", "उबदार", "चमकदार", "जलद"] }, correct: 0, explanation: { en: "Cold is the opposite of hot.", hi: "गर्म का विलोम ठंडा है.", mr: "उन्हाच्या विरुद्ध थंड आहे." } }
  ],
  CLASS_6_8: [
    ...
    { id: 3, question: { en: "Basic Current Affairs: Who is the current ISRO Chairman?", hi: "बेसिक करेंट अफेयर्स: वर्तमान में इसरो (ISRO) के अध्यक्ष कौन हैं?", mr: "बेसिक चालू घडामोडी: वर्तमान मधील ISRO चे अध्यक्ष कोण आहेत?" }, options: { en: ["Dr. S. Somanath", "K. Sivan", "A. P. J. Abdul Kalam", "Satish Dhawan"], hi: ["डॉ. एस. सोमनाथ", "के. सिवान", "ए. पी. जे. अब्दुल कलाम", "सतीश धवन"], mr: ["डॉ. एस. सोमनाथ", "के. सिवान", "ए. पी. जे. अब्दुल कलाम", "सतीश धवन"] }, correct: 0, explanation: { en: "Dr. S. Somanath heads ISRO.", hi: "डॉ. एस. सोमनाथ इसरो प्रमुख हैं.", mr: "डॉ. एस. सोमनाथ हे ISRO प्रमुख आहेत." } },
    ...
    { id: 5, question: { en: "Science: Chemical symbol for Sodium is:", hi: "विज्ञान: सोडियम का रासायनिक प्रतीक क्या है:", mr: "विज्ञान: सोडियमचे रासायनिक चिन्ह काय आहे:" }, options: { en: ["So", "Na", "Sd", "S"], hi: ["So", "Na", "Sd", "S"], mr: ["So", "Na", "Sd", "S"] }, correct: 1, explanation: { en: "Sodium symbol is Na.", hi: "सोडियम का प्रतीक Na है.", mr: "सोडियमचे चिन्ह Na आहे." } },
    { id: 6, question: { en: "Logical Reasoning: Find missing number: 3, 6, 9, 12, __", hi: "तर्कशक्ति: लुप्त संख्या ज्ञात करें: 3, 6, 9, 12, __", mr: "तर्कशास्त्र: गाळलेली संख्या शोधा: 3, 6, 9, 12, __" }, options: { en: ["14", "15", "18", "20"], hi: ["14", "15", "18", "20"], mr: ["14", "15", "18", "20"] }, correct: 1, explanation: { en: "Increases by +3: 12 + 3 = 15.", hi: "+3 की वृद्धि: 12 + 3 = 15.", mr: "+3 ने वाढ: 12 + 3 = 15." } },
    { id: 7, question: { en: "Mental Ability: Average of 10, 20, 30, 40, 50 is:", hi: "मानसिक क्षमता: 10, 20, 30, 40, 50 का औसत है:", mr: "मानसिक क्षमता: 10, 20, 30, 40, 50 ची सरासरी किती:" }, options: { en: ["25", "30", "35", "40"], hi: ["25", "30", "35", "40"], mr: ["25", "30", "35", "40"] }, correct: 1, explanation: { en: "Sum 150 / 5 = 30.", hi: "योग 150 / 5 = 30.", mr: "बेरीज 150 / 5 = 30." } },
    { id: 8, question: { en: "English: Choose proper adjective: 'He is a ___ boy.'", hi: "अंग्रेजी: उचित विशेषण चुनें: 'He is a ___ boy.'", mr: "इंग्रजी: योग्य विशेषण निवडा: 'He is a ___ boy.'" }, options: { en: ["run", "brave", "quickly", "and"], hi: ["run", "brave", "quickly", "and"], mr: ["run", "brave", "quickly", "and"] }, correct: 1, explanation: { en: "'Brave' is an adjective.", hi: "'Brave' विशेषण है.", mr: "'Brave' हे विशेषण आहे." } },
    { id: 9, question: { en: "Marathi: खालीलपैकी कोणती भाषा महाराष्ट्र राज्याची मुख्य भाषा आहे?", hi: "मराठी: महाराष्ट्र राज्य की मुख्य भाषा कौन सी है?", mr: "मराठी: महाराष्ट्र राज्य की मुख्य भाषा कौन सी है?" }, options: { en: ["हिंदी", "मराठी", "गुजराती", "तमिळ"], hi: ["हिंदी", "मराठी", "गुजराती", "तमिल"], mr: ["हिंदी", "मराठी", "गुजराती", "तमिळ"] }, correct: 1, explanation: { en: "Marathi is the primary language of Maharashtra.", hi: "मराठी महाराष्ट्र की मुख्य भाषा है.", mr: "मराठी ही महाराष्ट्राची मुख्य भाषा आहे." } },
    { id: 10, question: { en: "General Knowledge: Which instrument measures air pressure?", hi: "सामान्य ज्ञान: वायुदाब मापने का यंत्र कौन सा है?", mr: "सामान्य ज्ञान: हवाMोजणारे उपकरण कोणते आहे:" }, options: { en: ["Thermometer", "Barometer", "Ammeter", "Speedometer"], hi: ["थर्मामीटर", "बैरोमीटर", "एमीटर", "स्पीडोमीटर"], mr: ["थर्मामीटर", "बॅरोमीटर", "अॅमीटर", "स्पीडोमीटर"] }, correct: 1, explanation: { en: "Barometers measure pressure.", hi: "बैरोमीटर दाब मापता है.", mr: "बॅरोमीटर दाब मोजतो." } }
  ],
  CLASS_9_10: [
    { id: 1, question: { en: "Mathematics: If a train travels 240 km in 4 hours, its average speed is:", hi: "गणित: यदि एक ट्रेन 4 घंटे में 240 किमी चलती है, तो औसत चाल है:", mr: "गणित: जर ट्रेन 4 तासांत 240 किमी अंतर पार करते, तर सरासरी वेग किती:" }, options: { en: ["50 km/h", "60 km/h", "70 km/h", "80 km/h"], hi: ["50 किमी/घंटा", "60 किमी/घंटा", "70 किमी/घंटा", "80 किमी/घंटा"], mr: ["50 किमी/तास", "60 किमी/तास", "70 किमी/तास", "80 किमी/तास"] }, correct: 1, explanation: { en: "Speed = 240 / 4 = 60 km/h.", hi: "चाल = 240 / 4 = 60 किमी/घंटा.", mr: "वेग = 240 / 4 = 60 किमी/तास." } },
    { id: 2, question: { en: "Science: What is the pH value of pure distilled water?", hi: "विज्ञान: शुद्ध आसुत जल का pH मान कितना होता है?", mr: "विज्ञान: शुद्ध डिस्टिल्ड पाण्याचा pH मान किती असतो?" }, options: { en: ["5", "7", "9", "14"], hi: ["5", "7", "9", "14"], mr: ["5", "7", "9", "14"] }, correct: 1, explanation: { en: "Pure water has neutral pH 7.", hi: "शुद्ध पानी का तटस्थ pH 7 होता है.", mr: "शुद्ध पाण्याचा pH 7 असतो." } },
    { id: 3, question: { en: "Social Science: Which article guarantees Equality before Law in Indian Constitution?", hi: "सामाजिक विज्ञान: भारतीय संविधान का कौन सा अनुच्छेद कानून के समक्ष समानता की गारंटी देता है?", mr: "सामाजिक शास्त्र: भारतीय संविधानातील कोणते कलम कायद्यासमोर समानतेची हमी देते?" }, options: { en: ["Article 12", "Article 14", "Article 19", "Article 21"], hi: ["अनुच्छेद 12", "अनुच्छेद 14", "अनुच्छेद 19", "अनुच्छेद 21"], mr: ["कलम 12", "कलम 14", "कलम 19", "कलम 21"] }, correct: 1, explanation: { en: "Article 14 ensures equality before law.", hi: "अनुच्छेद 14 कानून के समक्ष समानता सुनिश्चित करता है.", mr: "कलम 14 कायद्यासमोर समानतेची हमी देते." } },
    ...
    { id: 5, question: { en: "Science: Value of sin(30°) in trigonometry is:", hi: "विज्ञान: त्रिकोणमिति में sin(30°) का मान है:", mr: "विज्ञान: त्रिकोणमितीमध्ये sin(30°) चे मूल्य किती आहे:" }, options: { en: ["0", "1/2", "1/√2", "1"], hi: ["0", "1/2", "1/√2", "1"], mr: ["0", "1/2", "1/√2", "1"] }, correct: 1, explanation: { en: "sin(30°) = 0.5 or 1/2.", hi: "sin(30°) = 0.5 या 1/2.", mr: "sin(30°) = 0.5 किंवा 1/2." } },
    { id: 6, question: { en: "Current Affairs: Headquarters of Reserve Bank of India (RBI) is in:", hi: "करेंट अफेयर्स: भारतीय रिजर्व बैंक (RBI) का मुख्यालय कहाँ स्थित है?", mr: "चालू घडामोडी: भारतीय रिझर्व्ह बँकेचे (RBI) मुख्यालय कुठे आहे:" }, options: { en: ["New Delhi", "Mumbai", "Kolkata", "Chennai"], hi: ["नई दिल्ली", "मुंबई", "कोलकाता", "चेन्नई"], mr: ["नवी दिल्ली", "मुंबई", "कोलकाता", "चेन्नई"] }, correct: 1, explanation: { en: "RBI headquarters is in Mumbai.", hi: "RBI का मुख्यालय मुंबई में है.", mr: "RBI चे मुख्यालय मुंबईत आहे." } },
    { id: 7, question: { en: "Logical Reasoning: If CAT = 24 and DOG = 26, then PIG = ?", hi: "तर्कशक्ति: यदि CAT = 24 और DOG = 26, तो PIG = ?", mr: "तर्कशास्त्र: जर CAT = 24 आणि DOG = 26, तर PIG = ?" }, options: { en: ["32", "30", "36", "40"], hi: ["32", "30", "36", "40"], mr: ["32", "30", "36", "40"] }, correct: 0, explanation: { en: "Sum of letters: P(16)+I(9)+G(7) = 32.", hi: "अक्षरों का योग: P(16)+I(9)+G(7) = 32.", mr: "अक्षरांची बेरीज: P(16)+I(9)+G(7) = 32." } },
    { id: 8, question: { en: "Science: Which human organ filters blood to produce urine?", hi: "विज्ञान: मानव शरीर में कौन सा अंग रक्त को छानकर मूत्र बनाता है?", mr: "विज्ञान: मानवी शरीरातील कोणता अवयव रक्ताचे गाळण करून मूत्र तयार करतो?" }, options: { en: ["Heart", "Lungs", "Kidney", "Liver"], hi: ["हृदय", "फेफड़े", "गुर्दा (किडनी)", "यकृत"], mr: ["हृदय", "फुफ्फुस", "मूत्रपिंड (किडनी)", "यकृत"] }, correct: 2, explanation: { en: "Kidneys filter waste products.", hi: "गुर्दे अपशिष्ट छानते हैं.", mr: "मूत्रपिंड टाकाऊ पदार्थ गाळतात." } },
    { id: 9, question: { en: "English: Select synonym for 'PERSISTENT':", hi: "अंग्रेजी: 'PERSISTENT' का पर्यायवाची चुनें:", mr: "इंग्रजी: 'PERSISTENT' चा समानार्थी शब्द निवडा:" }, options: { en: ["Temporary", "Determined", "Lazy", "Uncertain"], hi: ["अस्थाई", "दृढ़ / संकल्पित", "आलसी", "अनिश्चित"], mr: ["अस्थायी", "निश्चयी / दृढ", "आळशी", "अनिश्चित"] }, correct: 1, explanation: { en: "Persistent means determined.", hi: "Persistent का अर्थ दृढ़ होता है.", mr: "Persistent म्हणजे निश्चयी." } },
  ...
  CLASS_11_12: [
    { id: 1, question: { en: "Quantitative Aptitude: Derivative of sin(x) with respect to x is:", hi: "मात्रात्मक योग्यता: x के सापेक्ष sin(x) का अवकलज है:", mr: "परिमाण क्षमता: x च्या संदर्भात sin(x) चा डेरिव्हेटिव्ह काय आहे:" }, options: { en: ["-cos(x)", "cos(x)", "tan(x)", "-sin(x)"], hi: ["-cos(x)", "cos(x)", "tan(x)", "-sin(x)"], mr: ["-cos(x)", "cos(x)", "tan(x)", "-sin(x)"] }, correct: 1, explanation: { en: "d/dx(sin x) = cos x.", hi: "d/dx(sin x) = cos x.", mr: "d/dx(sin x) = cos x." } },
    { id: 2, question: { en: "Subject Aptitude (Physics): SI unit of Electric Charge is:", hi: "विषय योग्यता: विद्युत आवेश का SI मात्रक है:", mr: "विषय क्षमता: विद्युत चार्जचे SI एकक काय आहे:" }, options: { en: ["Farad", "Coulomb", "Tesla", "Weber"], hi: ["फैराड", "कूलम्ब", "टेस्ला", "वेबर"], mr: ["फॅरड", "कुलॉम्ब", "टेस्ला", "वेबर"] }, correct: 1, explanation: { en: "Charge is measured in Coulombs.", hi: "आवेश कूलम्ब में मापा जाता है.", mr: "चार्ज कुलॉम्बमध्ये मोजला जातो." } },
    { id: 3, question: { en: "Logical Reasoning: Complete series: 2, 6, 12, 20, 30, __", hi: "तर्कशक्ति: श्रृंखला पूरी करें: 2, 6, 12, 20, 30, __", mr: "तर्कशास्त्र: मालिका पूर्ण करा: 2, 6, 12, 20, 30, __" }, options: { en: ["40", "42", "45", "48"], hi: ["40", "42", "45", "48"], mr: ["40", "42", "45", "48"] }, correct: 1, explanation: { en: "Differences increase by +2: 30 + 12 = 42.", hi: "अंतर +2 बढ़ता है: 30 + 12 = 42.", mr: "फरक +2 ने वाढतो: 30 + 12 = 42." } },
    ...
    { id: 5, question: { en: "Subject Aptitude (Chemistry): Oxidation state of Oxygen in H₂O is:", hi: "विषय योग्यता: H₂O में ऑक्सीजन की ऑक्सीकरण अवस्था है:", mr: "विषय क्षमता: H₂O मधील ऑक्सिजनची ऑक्सिडेशन स्टेट काय आहे:" }, options: { en: ["+2", "-2", "-1", "0"], hi: ["+2", "-2", "-1", "0"], mr: ["+2", "-2", "-1", "0"] }, correct: 1, explanation: { en: "Oxygen oxidation number is -2.", hi: "ऑक्सीकरण संख्या -2 है.", mr: "ऑक्सिडेशन अंक -2 आहे." } },
    { id: 6, question: { en: "Current Affairs / Entrance Exams: Which institution conducts NEET entrance?", hi: "करेंट अफेयर्स: NEET परीक्षा कौन सी संस्था आयोजित करती है?", mr: "चालू घडामोडी: NEET परीक्षा कोणती संस्था आयोजित करते?" }, options: { en: ["UPSC", "NTA", "CBSE", "AIIMS"], hi: ["UPSC", "NTA", "CBSE", "AIIMS"], mr: ["UPSC", "NTA", "CBSE", "AIIMS"] }, correct: 1, explanation: { en: "NTA conducts NEET.", hi: "NTA NEET कराता है.", mr: "NTA द्वारे NEET घेतली जाते." } },
    { id: 7, question: { en: "English: Choose correct passive form for: 'She wrote a letter.'", hi: "अंग्रेजी: 'She wrote a letter.' का सही पैसिव रूप चुनें:", mr: "इंग्रजी: 'She wrote a letter.' चे योग्य पॅसिव्ह रूप निवडा:" }, options: { en: ["A letter was written by her.", "A letter is written by her.", "A letter has been written.", "She is writing a letter."], hi: ["A letter was written by her.", "A letter is written by her.", "A letter has been written.", "She is writing a letter."], mr: ["A letter was written by her.", "A letter is written by her.", "A letter has been written.", "She is writing a letter."] }, correct: 0, explanation: { en: "Simple past changes to 'was written by'.", hi: "भूतकाल 'was written by' बनता है.", mr: "भूतकाळात 'was written by' वापरले जाते." } },
    { id: 8, question: { en: "Quantitative Aptitude: Work done when displacement is perpendicular to force:", hi: "मात्रात्मक योग्यता: जब विस्थापन बल के लंबवत हो तो किया गया कार्य:", mr: "परिमाण क्षमता: जेव्हा विस्थापन बलाशी लंब असते तेव्हा केलेले कार्य:" }, options: { en: ["Maximum", "Zero", "Negative", "Infinite"], hi: ["अधिकतम", "शून्य", "ऋणात्मक", "अनंत"], mr: ["कमाल", "शून्य", "ऋणात्मक", "अनंत"] }, correct: 1, explanation: { en: "W = Fd cos(90°) = 0.", hi: "W = Fd cos(90°) = 0.", mr: "W = Fd cos(90°) = 0." } },
    { id: 9, question: { en: "General Knowledge: Light year is a unit of:", hi: "सामान्य ज्ञान: प्रकाश वर्ष किसकी इकाई है:", mr: "सामान्य ज्ञान: प्रकाश वर्ष कशाचे एकक आहे:" }, options: { en: ["Time", "Distance", "Speed", "Intensity"], hi: ["समय", "दूरी", "गति", "तीव्रता"], mr: ["वेळ", "अंतर", "वेग", "प्रखरता"] }, correct: 1, explanation: { en: "Light year measures distance.", hi: "प्रकाश वर्ष दूरी मापता है.", mr: "प्रकाश वर्ष अंतर मोजतो." } },
    { id: 10, question: { en: "Subject Aptitude: Which element has the highest electronegativity?", hi: "विषय योग्यता: किस तत्व की विद्युत ऋणात्मकता सबसे अधिक है?", mr: "विषय क्षमता: कोणत्या मूलद्रव्याची विद्युत ऋणात्मकता सर्वात जास्त आहे?" }, options: { en: ["Fluorine", "Chlorine", "Oxygen", "Nitrogen"], hi: ["फ्लोरिन", "क्लोरीन", "ऑक्सीजन", "नाइट्रोजन"], mr: ["फ्लुरिन", "क्लोरीन", "ऑक्सिजन", "नायट्रोजन"] }, correct: 0, explanation: { en: "Fluorine is most electronegative.", hi: "फ्लोरिन सबसे अधिक विद्युत ऋणात्मक है.", mr: "फ्लुरिन सर्वात जास्त विद्युत ऋणात्मक आहे." } }
  ],
  COMPETITIVE: [
    ...
    { id: 4, question: { en: "Computer Awareness: What does CPU stand for?", hi: "कंप्यूटर जागरूकता: CPU का पूर्ण रूप क्या है?", mr: "कम्प्युटर जागरूकता: CPU चा अर्थ काय आहे:" }, options: { en: ["Central Processing Unit", "Core Power Utility", "Central Performance Unit", "Control Program Unit"], hi: ["Central Processing Unit", "Core Power Utility", "Central Performance Unit", "Control Program Unit"], mr: ["Central Processing Unit", "Core Power Utility", "Central Performance Unit", "Control Program Unit"] }, correct: 0, explanation: { en: "CPU stands for Central Processing Unit.", hi: "CPU का अर्थ Central Processing Unit है.", mr: "CPU म्हणजे Central Processing Unit होय." } },
    { id: 5, question: { en: "Current Affairs: Who is known as the Father of the Indian Constitution?", hi: "करेंट अफेयर्स: भारतीय संविधान के जनक के रूप में किसे जाना जाता है?", mr: "चालू घडामोडी: भारतीय संविधानाचे जनक म्हणून कोणाला ओळखले जाते?" }, options: { en: ["Mahatma Gandhi", "Dr. B.R. Ambedkar", "Jawaharlal Nehru", "Sardar Patel"], hi: ["महात्मा गांधी", "डॉ. बी.आर. अम्बेडकर", "जवाहरलाल नेहरू", "सरदार पटेल"], mr: ["महात्मा गांधी", "डॉ. बी. आर. आंबेडकर", "जवाहरलाल नेहरू", "सरदार पटेल"] }, correct: 1, explanation: { en: "Dr. B.R. Ambedkar drafted the Constitution.", hi: "डॉ. बी.आर. अम्बेडकर ने संविधान का प्रारूप तैयार किया.", mr: "डॉ. बी. आर. आंबेडकर यांनी संविधानाचा मसुदा तयार केला." } },
    { id: 6, question: { en: "Reasoning: Look at series: 7, 10, 8, 11, 9, 12, __ What comes next?", hi: "तर्कशक्ति: श्रृंखला देखें: 7, 10, 8, 11, 9, 12, __ अगला क्या होगा?", mr: "तर्कशास्त्र: मालिका पहा: 7, 10, 8, 11, 9, 12, __ पुढे काय येईल?" }, options: { en: ["7", "10", "12", "13"], hi: ["7", "10", "12", "13"], mr: ["7", "10", "12", "13"] }, correct: 1, explanation: { en: "Alternating sequence pattern: 12 - 2 = 10.", hi: "पैटर्न: 12 - 2 = 10.", mr: "पॅटर्न: 12 - 2 = 10." } },
    { id: 7, question: { en: "English: Choose antonym of 'ABUNDANT':", hi: "अंग्रेजी: 'ABUNDANT' का विलोम शब्द चुनें:", mr: "इंग्रजी: 'ABUNDANT' चा विरुद्धार्थी शब्द निवडा:" }, options: { en: ["Scarce", "Plentiful", "Ample", "Rich"], hi: ["दुर्लभ (Scarce)", "प्रचुर", "भरपूर", "अमीर"], mr: ["तुटवडा / अपुरे (Scarce)", "प्रचुर", "भरपूर", "श्रीमंत"] }, correct: 0, explanation: { en: "'Scarce' is opposite of abundant.", hi: "'Scarce' प्रचुर का विलोम है.", mr: "'Scarce' म्हणजे अपुरे." } },
    { id: 8, question: { en: "General Knowledge: Which river basin is the largest in India?", hi: "सामान्य ज्ञान: भारत में सबसे बड़ा नदी बेसिन कौन सा है?", mr: "सामान्य ज्ञान: भारतातील सर्वात मोठे नदी खोरे कोणते आहे:" }, options: { en: ["Ganga", "Godavari", "Krishna", "Narmada"], hi: ["गंगा", "गोदावरी", "कृष्णा", "नर्मदा"], mr: ["गंगा", "गोदावरी", "कृष्णा", "नर्मदा"] }, correct: 0, explanation: { en: "Ganga basin is India's largest.", hi: "गंगा बेसिन भारत का सबसे बड़ा है.", mr: "गंगा खोरे भारतातील सर्वात मोठे आहे." } },
    ...
    { id: 10, question: { en: "Computer Awareness: Shortcut key for 'Copy' in Windows is:", hi: "कंप्यूटर जागरूकता: Windows में 'Copy' करने की शॉर्टकट की क्या है:", mr: "कम्प्युटर जागरूकता: Windows मध्ये 'Copy' करण्यासाठी शॉर्टकट की कोणती:" }, options: { en: ["Ctrl + C", "Ctrl + V", "Ctrl + X", "Ctrl + A"], hi: ["Ctrl + C", "Ctrl + V", "Ctrl + X", "Ctrl + A"], mr: ["Ctrl + C", "Ctrl + V", "Ctrl + X", "Ctrl + A"] }, correct: 0, explanation: { en: "Ctrl + C copies text.", hi: "Ctrl + C से कॉपी होता है.", mr: "Ctrl + C ने कॉपी होते." } }
  ]
};
        ...
        <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xl p-6 md:p-10 space-y-8">
          ...
          {step === 4 && (
            <div className="space-y-10 animate-fade-in">
              ...
              {/* 2. OVERALL SCORECARD & 3. DYNAMIC GROUP-SPECIFIC SUBJECT ANALYTICS */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* EXACT TIER SUBJECT-WISE ANALYTICS */}
                <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-xl space-y-6">
                  <div className="flex items-center justify-between">
                    <h4 className="text-sm font-black text-[#01295A] uppercase tracking-wider flex items-center gap-2">
                      <TrendingUp className="w-4 h-4 text-[#FE7C02]" />
                      <span>Subject-Wise Analytics ({activeClassObj.group})</span>
                    </h4>
                  ...
                  <div className="p-3.5 bg-indigo-50/70 rounded-2xl border border-indigo-100 text-[11px] text-indigo-900 font-medium flex items-start gap-2">
                    ...
                    <span>Strong proficiency in {activeClassObj.subjects[0]}. Keep practicing to achieve top state rank in {activeClassObj.group}.</span>
                  </div>
                </div>
